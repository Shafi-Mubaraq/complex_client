    ...
    <div className="min-h-screen bg-[#F8FAFC] font-sans text-slate-900 pb-12">
      ...
      <div className="bg-white/80 backdrop-blur-md border-b border-slate-200 sticky top-0 z-20">
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          <div className="flex items-center gap-2 text-sm font-medium text-slate-500">
            ...
            <span className="text-slate-900 font-semibold">My Leases</span>
          </div>
          <button className="flex items-center gap-2 bg-indigo-50 text-indigo-600 hover:bg-indigo-100 px-4 py-2 rounded-xl text-sm font-bold transition-all">
      ...
      <div className="max-w-7xl mx-auto px-6 py-10">
        ...
        <div className="space-y-10">
          {leases.map((lease) => (
            <div key={lease._id} className="bg-white rounded-[2.5rem] shadow-sm border border-slate-200 overflow-hidden hover:shadow-xl hover:shadow-indigo-50/50 transition-all duration-500">
...
const SummaryCard = ({ title, value, icon, color }) => {
  ...
  return (
    <div className="bg-white p-7 rounded-[2rem] shadow-sm border border-slate-200 flex items-center gap-5">
