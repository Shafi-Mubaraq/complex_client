                ...
                <div className="p-8 md:p-10 bg-white">
                    <div className="space-y-4">
                        <p className="text-sm font-medium text-slate-600 leading-relaxed">
                            You are about to permanently remove <span className="font-bold text-slate-900 underline decoration-rose-200 underline-offset-4">{propertyTitle || 'this asset'}</span> from the enterprise inventory.
                        </p>

                        <div className="bg-rose-50 border border-rose-100 rounded-xl p-4">
                            <p className="text-[11px] font-bold text-rose-700 uppercase tracking-wider mb-1">Critical Warning</p>
                            <p className="text-xs text-rose-600 font-medium leading-relaxed">
                                This action is irreversible. All associated tenancy history, property media, and financial logs will be archived or purged from the central database.
                            </p>
                        </div>
                    </div>
