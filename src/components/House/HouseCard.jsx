...
import React from "react";
import { MapPin, Maximize2, ArrowRight, ShieldCheck, Zap, Wallet } from "lucide-react";
    ...
    return (
        <div className="group bg-white border border-slate-200 rounded-[1.5rem] overflow-hidden flex flex-col transition-all duration-500 hover:shadow-[0_25px_50px_-12px_rgba(0,0,0,0.08)] hover:border-slate-300">
            ...
            <div className="p-7 flex flex-col flex-grow">
                ...
                {/* Filtered Specs: Only Rent, Deposit, Area */}
                <div className="grid grid-cols-2 gap-px bg-slate-100 border border-slate-100 rounded-xl overflow-hidden mb-8">
                    <div className="bg-white p-4 flex flex-col gap-1">
                        <div className="flex items-center gap-2 text-slate-400">
                            <Wallet size={14} />
                            <span className="text-[9px] font-black uppercase tracking-tighter">Security Deposit</span>
                        </div>
                        <span className="text-xs font-bold text-slate-700 uppercase">₹{house.deposit?.toLocaleString()}</span>
                    </div>
                    <div className="bg-white p-4 flex flex-col gap-1">
                        <div className="flex items-center gap-2 text-slate-400">
                            <Maximize2 size={14} />
